...
//     // ✅ pdfElement वर declare केला — दोन्ही then/catch मध्ये available
//     const pdfElement = document.createElement("div");
//     pdfElement.style.width = "210mm";
//     pdfElement.style.minHeight = "297mm";
//     pdfElement.style.padding = "15mm";
...
//     // ✅ HTML build करणारा helper — imgSrc parameter घेतो
...
//         pdfElement.innerHTML = buildHTML("/user2.png"); // ✅ local fallback
//         document.body.appendChild(pdfElement);
//         savePDF().then(resolve).catch(reject);
//       });
//   });
...
//         // ✅ Valid format check
//         if (parts.length !== 3) {
//           isJodpatra3 = true; // default to Jodpatra-3
//         } else {
