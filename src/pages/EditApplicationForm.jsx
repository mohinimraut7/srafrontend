...
<div>
  ...
  <Field
    ...
    className="w-full border rounded-md px-3 py-2"
  />
  <ErrorMessage name="aadhaar_pincode" component="div" className="text-red-500 text-sm" />
</div>
...
<div>
  ...
  <Field
    ...
    className="w-full border rounded-md px-3 py-2"
  />
  <ErrorMessage name="current_pincode" component="div" className="text-red-500 text-sm" />
</div>
...
<div>
  ...
  <Field
    ...
    className="w-full border rounded-md px-3 py-2"
  />
  <ErrorMessage name="current_mobile_number" component="div" className="text-red-500 text-sm" />
</div>
...
<div>
  ...
  <Field
    ...
    onChange={(e) => {
      setFieldValue("voter_card_type", e.target.value);
      setFieldValue("voter_card_number", ""); // ✅ Reset when type changes
    }}
    className="w-full border rounded-md px-3 py-2"
  >
    <option value="">Select</option>
...
{/* Dynamic Voter Card Number */}
{values.voter_card_type && (
  <div>
    <label className="block text-sm font-medium text-gray-700 mb-2">
      Voter Card Number (
      {values.voter_card_type === "EPIC 10 Digit" ? "10" : "14"} characters) *
    </label>
    ...
    <Field name="voter_card_number">
      {({ field }) => (
        <input
          ...
          type="text"
          maxLength={
            values.voter_card_type === "EPIC 10 Digit" ? 10 : 14
          }
          placeholder={
            values.voter_card_type === "EPIC 10 Digit"
              ? "ABC1234567"
              : "ABC12345678901"
          }
          onChange={(e) => {
            const value = e.target.value
              .toUpperCase()
              .replace(/[^A-Z0-9]/g, "");
            setFieldValue("voter_card_number", value);
          }}
          className="w-full border rounded-md px-3 py-2"
        />
      )}
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                      ...
                      {/* {[
                        ...
                        { name: "doc_side_view", label: "Side View", accept: "image/*", icon: "", db: "doc_side_view" },
                        { name: "adivashihutimage", label: "Hut Image", accept: "image/*,.pdf", icon: "", db: "adivashihutimage" },
                        ...(new Date(values.residency_since) <= new Date("2000-01-01")
                          ? [
                              { name: "doc_before_2000", label: "Hut Owner Document Before 2000 Proof", accept: "image/*,.pdf", icon: "", db: "doc_before_2000" },
                              { name: "submitted_docs_before_2000", label: "Hut Owner Document Before 2000 Proof", accept: "image/*,.pdf", icon: "", db: "submitted_docs_before_2000" },
                            ]
                          : []),
                        ...(new Date(values.residency_since) > new Date("2000-01-01")
                          ? [{ name: "after_2000_proof_submitted", label: "Hut Owner Document After 2000 Proof", accept: "image/*,.pdf", icon: "", db: "after_2000_proof_submitted" }]
                          : []),
                        { name: "possession_doc_info", label: "Possession Doc", accept: "image/*,.pdf", icon: "", db: "possession_doc_info" },
                        { name: "Seldeclaration_letter", label: "Self Declaration", accept: "image/*,.pdf", icon: "", db: "Seldeclaration_letter" },
                        { name: "Ration_card_info", label: "Ration Card", accept: "image/*,.pdf", icon: "", db: "Ration_card_info" },
                        { name: "sale_agreement", label: "Sale Agreement (multi)", accept: ".pdf,.doc,.docx,image/*", icon: "", db: "sale_agreement", multiple: true },
                        { name: "biometric", label: "Biometric", accept: "image/*", icon: "", db: "biometric" },
                        { name: "video_self_declaration", label: "Self Declaration Video", accept: "video/*", icon: "", db: "video_self_declaration" },
                        { name: "video_inside", label: "Inside Video", accept: "video/*", icon: "", db: "video_inside" },
                      ].map(({ name, label, accept, icon, db, multiple }) => (
