...
const generateJodpatra4 = (data) => {
  ...
  const handleSubmit = async (values) => {
    ...
    try {
      ...
      const submittedByValue = currentUser?.role || userRole || 'user'
      ...
      console.log("Submitting with submittedBy:", submittedByValue)
      ...
      await generateAndDownloadPdfs(updatedValues)
  ...
  const renderStepContent = (formik) => {
    switch (currentStep) {
      ...
      case 7:
        return (
          <div className="space-y-6">
            <h3 className="text-2xl font-bold text-gray-900 mb-6">Metadata Information</h3>
                ...
                <div className="space-y-4">
                  <div className="p-4 bg-white rounded-lg border border-gray-200">
                    ...
                    <p className="text-xs text-gray-500 mt-1">
                      This will be automatically filled based on your login role
                    </p>
                  </div>
                  ...
                  <div className="p-4 bg-white rounded-lg border border-gray-200">
                    ...
                    <p className="text-xs text-gray-500 mt-1">
                      This will be automatically set when submitting
                    </p>
                  </div>
                </div>
                  ...
                  <div className="p-4 bg-white rounded-lg border border-gray-200">
                    <div className="flex items-center space-x-3 mb-2">
                      <Field
                        ...
                        className="h-5 w-5 text-blue-600 focus:ring-blue-500 border-gray-300 rounded transition-all"
                      />
                      <label className="text-sm font-medium text-gray-700">Self Declaration Letter</label>
                    </div>
                    <p className="text-xs text-gray-500">
                      Confirm that you have provided the self declaration letter
                    </p>
                  </div>
                  ...
                  <div className="p-4 bg-white rounded-lg border border-gray-200">
                    <div className="flex items-center space-x-3 mb-2">
                      <Field
                        ...
                        className="h-5 w-5 text-blue-600 focus:ring-blue-500 border-gray-300 rounded transition-all"
                      />
                      <label className="text-sm font-medium text-gray-700">After 2000 Proof Submitted</label>
                    </div>
                    <p className="text-xs text-gray-500">
                      Confirm that you have submitted proof documents after year 2000
                    </p>
                  </div>
                </div>
              </div>
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-indigo-50 py-8">
      <div className="max-w-6xl mx-auto px-4">
        ...
        <div className="bg-white rounded-xl shadow-xl p-8 mb-6">
          ...
          <Formik
            initialValues={{...initialValues, submittedBy: userRole || ''}}
