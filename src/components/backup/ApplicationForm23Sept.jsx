...
import { ChevronLeft, ChevronRight, Save, Upload, Download, Camera, CheckCircle, Calendar } from 'lucide-react'
...
const ApplicationForm = ({ onClose, onSuccess }) => {
  ...
  const handlePhotoVerification = () => {
    ...
    setPhotoVerification({
      verified: true,
      timestamp: now.toLocaleString('mr-IN', {
        year: 'numeric',
        month: 'long',
        day: 'numeric',
        hour: '2-digit',
      ...
      location: 'Mumbai, Maharashtra' // You can implement actual geolocation here
    })
  }
          ...
          <div className="space-y-8">
            ...
            <div className="bg-gradient-to-r from-purple-50 to-pink-50 rounded-xl p-6 border border-purple-100 mb-8">
              <h4 className="text-xl font-semibold text-gray-800 mb-6 flex items-center">
                ...
                Photo Verification - मी खालील नमूद केलेल्या माहितीची खात्री देतो
              </h4>
              ...
              <div className="grid md:grid-cols-2 gap-6">
                  ...
                  <div className="p-4 bg-white rounded-lg border border-purple-200">
                    ...
                    {!photoVerification.verified ? (
                      <button
                        ...
                        className="w-full px-4 py-3 bg-gradient-to-r from-purple-600 to-pink-600 text-white rounded-lg hover:from-purple-700 hover:to-pink-700 font-semibold transition-all flex items-center justify-center gap-2"
                      >
                        <Camera className="w-5 h-5" />
                        Verify Information - माहिती सत्यापित करा
                      </button>
                    ) : (
                      <div className="space-y-2">
                        ...
                        <div className="text-sm text-gray-600">
                          <div className="flex items-center mb-1">
                            ...
                            दिनांक: {photoVerification.timestamp}
                          </div>
                          <div className="text-xs text-gray-500">
                            Location: {photoVerification.location}
                          </div>
                        </div>
                      </div>
                    )}
                ...
                <div className="p-4 bg-white rounded-lg border border-purple-200">
                  <h5 className="font-semibold text-gray-700 mb-3">Declaration - घोषणा</h5>
                  <div className="text-sm text-gray-600 space-y-2">
                    <p>• मी खालील नमूद केलेल्या माहितीची खात्री देतो</p>
                    <p>• सर्व माहिती सत्य आणि अचूक आहे</p>
                    <p>• कोणतीही खोटी माहिती दिली नाही</p>
                    <p>• मी या अर्जाची जबाबदारी घेतो</p>
                  </div>
                </div>
              </div>
            </div>
