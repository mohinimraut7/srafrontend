...
const validationSchemas = {
 ...
 family_member1_aadhaar: Yup.string()
      ...
      .test(
       ...
       family_member2_aadhaar: Yup.string()
      .required('Aadhaar number is required')
      .test(
        'is-valid-aadhaar',
        'Enter a valid Aadhaar number',
...
//         <p><strong>अर्ज क्र: ${data.slum_id || "ME_08403185"}</strong> 
//         <span style="float: right;"><strong>दिनांक:-${new Date().toLocaleDateString("en-GB")}</strong></span></p>
//         <p><strong>a. झोपडिवासियाचे नाव :-</strong> ${data.first_name || ""} ${data.last_name || ""}</p>
...
//       <div style="margin-bottom: 20px;">
//         <p><strong>e. झोपडिवासिय सध्याच्या झोपडीत केव्हापासून राहत आहे :- ${data.residency_since || ""}</strong></p>
//         <p><strong>f. कुटुंबातील सदस्यांची नावे:-</strong></p>
...
//               ${
//                 base64Image
//                   ? `<img src="${base64Image}" alt="Applicant Photo" style="width: 100%; height: 100%; object-fit: cover;" />`
//                   : `<span style="font-size: 10px;">अर्जदाराचा<br>फोटो</span>`
//               }
//             </div>
//             <p style="margin-top: 5px; font-size: 10px; font-weight: bold;">अर्जदाराचा फोटो</p>
//           </div>
...
//             </div>
//             <p style="margin-top: 8px; font-size: 10px; font-weight: bold;">अर्जदाराची सही / अंगठा निशाणी</p>
...
//       <div style="margin-bottom: 20px;">
//         <p><strong>g. झोपडी दि. ०१.०१.२००० रोजी अथवा त्यापूर्वी अस्तित्वात असताना पुरावा :-</strong></p>
//         <p><strong>(अ) पुरावा :- ${data.proof || "N/A"}</strong></p>
//         <p><strong>h. अलिकडच्या एका वर्षातील पुरावा :- ${data.recent_proof || "N/A"}</strong></p>
//         <p>i. स्वयं घोषणापत्र :- ${data.declaration || "आहे"}</p>
//       </div>
//     `;
...
// ✅ URL ला Base64 मध्ये convert करणारी helper function
...
//         <div style="text-align: center;">
//           <div style="border: 2px solid #000; width: 100px; height: 100px; margin: 0 auto; display: flex; align-items: center; justify-content: center;">
...
//         <div style="text-align: center;">
//           <div style="border: 2px solid #000; width: 80px; height: 80px; margin: 0 auto; display: flex; align-items: center; justify-content: center;">
//             <span style="font-size: 8px;">QR Code</span>
//           </div>
//           <p style="margin-top: 10px; font-size: 10px; font-weight: bold;">अर्जदाराची सही / अंगठा निशाणी</p>
//           <div style="margin-top: 5px; border-top: 1px solid #000; width: 120px; margin-left: auto; margin-right: auto;"></div>
